...
-   **Monitoraggio dual-layer coverage parity (release-over-release):** [dual_layer_coverage_monitoring.md](docs/AI_powered_rescheduling/dual_layer_coverage_monitoring.md)
