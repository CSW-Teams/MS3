...
### Protocol overview
- **Mode**: Direct prompting with system prompt, no MCP/RLM (Story 2). 
...
- **Tie-break**: Lexicographic order (to be evaluated and changed later)
...
2. Confirmation modal is shown with bilingual copy (EN/IT). (to be changed in future version)
