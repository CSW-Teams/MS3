...
export class AssegnazioneTurnoAPI {
  ...
  async getAvailableUsersForShiftExchange(params) {
    ...
    const response = await fetchWithAuth('/api/concrete-shifts/available-users-for-replacement/', requestOptions);
  ...
  async getShiftByIdUser(id) {
    const response = await fetchWithAuth('/api/concrete-shifts/user_id=' + id);
    const body = await response.json();
  ...
  async postAssegnazioneTurno(data, turnoTipologia, utentiSelezionatiGuardia, utentiReperibilita, servizio, mansione, forced) {
    ...
    return await fetchWithAuth('/api/concrete-shifts/', requestOptions);
  ...
  async requestShiftChange(utenteCambio, assegnazione, idLoggato) {
    ...
    let response = await fetchWithAuth('/api/change-shift-request/', requestOptions);
  ...
  async eliminaAssegnazioneTurno(idDaEliminare) {
    ...
    const response = await fetchWithAuth('/api/concrete-shifts/' + idDaEliminare, requestOptions);
    return response;
  ...
  async getGlobalShift() {
    const response = await fetchWithAuth('/api/concrete-shifts/');
    const body = await response.json();
  ...
  async postGenerationSchedule(dataStart, dataEnd) {
    ...
    const response = await fetchWithAuth('/api/schedule/generation', requestOptions);
