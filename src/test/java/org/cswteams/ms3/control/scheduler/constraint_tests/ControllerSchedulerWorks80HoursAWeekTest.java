...
public class ControllerSchedulerWorks80HoursAWeekTest extends ControllerSchedulerTest {
    ...
    public void populateDB() {
        ...
        Set<DayOfWeek> daysOfWeek = new HashSet<>(List.of(
                DayOfWeek.MONDAY,
                DayOfWeek.TUESDAY,
                DayOfWeek.WEDNESDAY,
                DayOfWeek.THURSDAY,
        ...
        Shift shift1Bis = new Shift(LocalTime.of(15, 0),
                Duration.ofHours(8),
                repartoAlogia,
                TimeSlot.AFTERNOON,
        ...
        Shift shift2Bis = new Shift(LocalTime.of(15, 0),
                Duration.ofHours(8),
                repartoBlogia,
                TimeSlot.AFTERNOON,
