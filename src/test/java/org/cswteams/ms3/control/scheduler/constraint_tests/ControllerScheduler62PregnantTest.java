...
public class ControllerScheduler62PregnantTest extends ControllerSchedulerTest {
    ...
    public void populateDB() {
        ...
        try {
            ...
            userController.addCondition(doc1, over62);
            userController.addSpecialization(doc2, b_logia);
            userController.addCondition(doc2, pregnant);
        } catch (Exception e) {
            fail();
        }
        ...
        QuantityShiftSeniority repartoAlogiaQssBis = new QuantityShiftSeniority(alogiaQuantities, ward) ;
        ...
        QuantityShiftSeniority repartoBlogiaQssBis = new QuantityShiftSeniority(blogiaQuantities, ward);
        ...
        Shift shift1Bis = new Shift(LocalTime.of(12, 0),
                Duration.ofHours(4),
                repartoAlogia,
                TimeSlot.AFTERNOON,
                Collections.singletonList(repartoAlogiaQssBis),
                monday,
                Collections.emptyList());
        ...
        Shift shift2 = new Shift(LocalTime.of(8, 0),
                ...
                repartoBlogia,
                TimeSlot.MORNING,
                Collections.singletonList(repartoBlogiaQssBis),
                monday,
                Collections.emptyList());
        shiftDAO.saveAndFlush(shift2);

        Shift shift2Bis = new Shift(LocalTime.of(12, 0),
                Duration.ofHours(4),
                repartoBlogia,
                TimeSlot.AFTERNOON,
                ...
                monday,
                Collections.emptyList());
        shiftDAO.saveAndFlush(shift2Bis);
