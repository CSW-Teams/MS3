...
public class ControllerSchedulerNoLongShiftPostNightTest extends ControllerSchedulerTest {
    ...
    public void populateDB() {
        ...
        QuantityShiftSeniority repartoAlogiaQssLong = new QuantityShiftSeniority(alogiaQuantities, ward);
        ...
        Shift shift1 = new Shift(LocalTime.of(20, 0),
                Duration.ofHours(8),
                repartoAlogia,
                TimeSlot.NIGHT,
        ...
        Shift shift1Long = new Shift(LocalTime.of(8, 0),
                Duration.ofHours(16),
                repartoAlogia,
                TimeSlot.MORNING,
                Collections.singletonList(repartoAlogiaQssLong),
                tuesday,
                Collections.emptyList());
        shiftDAO.saveAndFlush(shift1Long);
