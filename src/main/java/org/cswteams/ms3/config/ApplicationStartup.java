...
public class ApplicationStartup implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private void populateDB() throws TurnoException {
        ...
        Utente u7 = new Utente("Luca","Fiscariello", "FSCRLC******", LocalDate.of(1998, 8, 12),"lucafiscariello", "passw",RuoloEnum.STRUTTURATO,AttoreEnum.UTENTE);
        ...
        Utente u11 = new Utente("Giada","Rossi", "******", LocalDate.of(1997, 3, 14),"**@gmail.com", "passw", RuoloEnum.SPECIALIZZANDO ,AttoreEnum.UTENTE);
        u11.getTurnazioni().add(repartoOncologia);
        Utente u12 = new Utente("Camilla","Verdi", "******", LocalDate.of(1997, 5, 23),"***@gmail.com", "passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u12.getTurnazioni().add(repartoCardiologia);
        Utente u13 = new Utente("Federica","Pollini", "******", LocalDate.of(1998, 2, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u13.getTurnazioni().add(repartoCardiologia);
        Utente u14 = new Utente("Claudia","Rossi", "******", LocalDate.of(1982, 7, 6),"***@gmail.com@gmail.com", "passw", RuoloEnum.STRUTTURATO,AttoreEnum.UTENTE);
        u14.getSpecializzazioni().add(oncologo);
        Utente u15 = new Utente("Giorgio","Bianchi", "******", LocalDate.of(1993, 2, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.STRUTTURATO,AttoreEnum.UTENTE);
        u15.getSpecializzazioni().add(oncologo);
        Utente u16 = new Utente("Claudio","Gialli", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.STRUTTURATO,AttoreEnum.UTENTE);
        u16.getSpecializzazioni().add(cardiologo);
        Utente u17 = new Utente("Filippo","Neri", "******", LocalDate.of(1998, 2, 12),"***@gmail.com@gmail.com@gmail.com", "passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u17.getTurnazioni().add(ambulatorioCardiologia);
        Utente u18 = new Utente("Vincenzo","Grassi", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.STRUTTURATO,AttoreEnum.UTENTE);
        u18.getSpecializzazioni().add(oncologo);
        Utente u19 = new Utente("Diana","Pasquali", "******", LocalDate.of(1998, 2, 12),"***@gmail.com@gmail.com@gmail.com", "passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u19.getTurnazioni().add(ambulatorioCardiologia);
        Utente u20 = new Utente("Francesco","Lo Presti", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.STRUTTURATO,AttoreEnum.UTENTE);
        Utente u21 = new Utente("Andrea","Pepe", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u21.getTurnazioni().add(ambulatorioOncologia);
        Utente u22 = new Utente("Matteo","Fanfarillo", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com","passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u22.getTurnazioni().add(repartoOncologia);
        Utente u23 = new Utente("Matteo","Ciccaglione", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com","passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u23.getTurnazioni().add(repartoOncologia);
        Utente u24 = new Utente("Vittoria","De Nitto", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.STRUTTURATO,AttoreEnum.UTENTE);
        u24.getSpecializzazioni().add(oncologo);
        Utente u25 = new Utente("Valeria","Cardellini", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.STRUTTURATO,AttoreEnum.UTENTE);
        u25.getSpecializzazioni().add(oncologo);
        Utente u26 = new Utente("Roberto","Monte", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com","passw", RuoloEnum.STRUTTURATO,AttoreEnum.UTENTE);
        u26.getSpecializzazioni().add(cardiologo);
        Utente u27 = new Utente("Giovanni","Saggio", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.STRUTTURATO,AttoreEnum.UTENTE);
        u27.getSpecializzazioni().add(cardiologo);
        Utente u28 = new Utente("Livia","Simoncini", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com","passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u28.getTurnazioni().add(repartoCardiologia);
        Utente u29 = new Utente("Ludovico","Zarrelli", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u29.getTurnazioni().add(repartoCardiologia);
        Utente u30 = new Utente("Alessandro","Montenegro", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u30.getTurnazioni().add(ambulatorioOncologia);
        Utente u31 = new Utente("Daniel","Lungu", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com","passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u31.getTurnazioni().add(repartoCardiologia);
        Utente u32 = new Utente("Andrea","Tosti", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com","passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u32.getTurnazioni().add(repartoCardiologia);
        Utente u33 = new Utente("Giorgio","Pesce", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
        u33.getTurnazioni().add(repartoOncologia);
        Utente u34 = new Utente("Valerio","Palmerini", "******", LocalDate.of(1998, 8, 12),"***@gmail.com@gmail.com", "passw", RuoloEnum.SPECIALIZZANDO,AttoreEnum.UTENTE);
