...
public class ScheduleBuilder {
    ...
    private void addDoctors(ConcreteShift concreteShift, Map.Entry<Seniority, Integer> qss, List<Doctor> doctorList,
        ...
        for(DoctorUffaPriority dup: allDoctorUffaPriority){
            ...
            // [BASELINE-FLOW] CRITICITÀ HARD/SOFT:
            // Qui 'isForced' è passato come 'false'. Questo tratta tutti i vincoli (anche quelli Soft)
            // come Hard, bloccando l'assegnazione. L'AI dovrà poter passare 'true' qui.
