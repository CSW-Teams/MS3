...
public class MappaTurni {
    ...
    public static TurnoDTO turnoEntityToDTO(Turno entity){
        TurnoDTO dto = new TurnoDTO(entity.getId(), entity.getTipologiaTurno(),entity.getOraInizio(), entity.getOraFine(), MappaServizio.servizioEntitytoDTO(entity.getServizio()), entity.getMansione(), entity.isGiornoSuccessivo(), entity.isReperibilitaAttiva(), entity.getRuoliNumero());
