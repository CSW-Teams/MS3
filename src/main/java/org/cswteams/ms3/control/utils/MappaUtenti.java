...
public class MappaUtenti {
    ...
    public static Utente utenteDTOtoEntity(UtenteDTO utenteDTO) {
        return new Utente(utenteDTO.getId(),utenteDTO.getNome(),utenteDTO.getCognome(),utenteDTO.getCodiceFiscale(),utenteDTO.getDataNascita(),utenteDTO.getEmail(), utenteDTO.getRuoloEnum());
    }
